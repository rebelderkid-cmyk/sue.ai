        ...
        <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto flex h-16 items-center px-4 md:px-6">
                <Link href="/" className="mr-6 flex items-center space-x-2">
                    {/* Logo Placeholder */}
                    <span className="text-xl font-bold tracking-tight text-indigo-600">Law5 AI</span>
                </Link>
                <nav className="hidden md:flex flex-1 items-center justify-between">
                    <div className="flex items-center space-x-6 text-sm font-medium">
                        <Link href="/chat" className="transition-colors hover:text-foreground/80 text-foreground/60">AI Chat</Link>
                        <Link href="/search" className="transition-colors hover:text-indigo-600 text-indigo-500 font-semibold">AI Research</Link>
